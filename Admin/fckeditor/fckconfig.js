...
FCKConfig.ToolbarSets["Default"] = [
	['Source','-','NewPage','Preview','-','Templates'],//['Source','DocProps','-','Save','NewPage','Preview','-','Templates'],
	['Cut','Copy','Paste','PasteText','PasteWord','-','Print'],//['Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck'],
